package com.bisweswar.servlets;
import java.io.*;
				...
				try {
					...
					if(rs.next()) 
					{
						...
						pw.println("<div class='tab'>" + 
								...
								"		</p1>" + 
								"	</div>");
						pw.println("<div class='main'><p1 class='menu'>Trains BetWeen Station "+req.getParameter("fromstation")+" and "+req.getParameter("tostation")+"</p1></div>");
